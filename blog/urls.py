...
urlpatterns = [
    ...
    path('post/<str:slug>/update/', PostUpdate.as_view(), name='post_update_url' ), #изменяет пост
    ...
    path('tag/<str:slug>/update/', TagUpdate.as_view(), name='tag_update_url'), #изменяет тэк
    path('tag/<str:slug>/delete/', TagDelete.as_view(), name='tag_delete_url') #удаляет объект
]